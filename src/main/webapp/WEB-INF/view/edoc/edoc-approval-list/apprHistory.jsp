    ...
    <body>
        <div id="">
            ...
            <div id="workspace-area" class="subsidebar-from-workspace">
                <div>
                    <div class="mb-3">
                        <span class="display-6 fw-semibold mb-0">결재 내역</span>
                    </div>
                        ...
                        <c:choose>
                                    ...
                                    <table class="table table-hover">
                                        <thead>
                                            <tr class="text-center">
                                                ...
                                                <th class="edoc-done-date">결재상태</th>
                                                <th class="edoc-done-date">최종결재일</th>
                                            </tr>
                                        </thead>
                                        <!-- 문서 조회 반복문 영역 -->
                                                ...
                                                <tr onclick="location.href='/gaent/edocDetail/${el.edocType}/${el.edocNum}'" class="text-center">
                                                    ...
                                                    <c:choose>
                                                        <c:when test="${el.edocStatus == '-1' }">
                                                            <td class="fw-medium"><span class="badge bg-label-danger fs-6">반려</span></td>
                                                        </c:when>
                                                        <c:when test="${el.edocDoneDate == null}">
                                                            <td class="fw-medium"><span class="badge bg-label-warning fs-6">진행중</span></td>
                                                        </c:when>
                                                        <c:otherwise>
                                                            <td class="fw-medium"><span class="badge bg-label-success fs-6">승인</span></td>
                                                        </c:otherwise>
                                                    </c:choose>
                            ...
                            <c:otherwise>
                                <div class="table-responsive text-nowrap h-100 d-flex align-items-center">
                                    <span class="display-6 fw-semibold mb-0">결재 내역이 없습니다.</span>
                                </div>
                            </c:otherwise>
                        </c:choose>
                    </div>
