<%@page import="java.util.Map"%> <%@ taglib prefix="c"
uri="http://java.sun.com/jsp/jstl/core"%> <%@ taglib prefix="fn"
uri="http://java.sun.com/jsp/jstl/functions"%> <%@ page language="java"
...
<body>
  ...
  >
    ...
    <ul class="menu-inner py-3">
      ...
      <li
        class="menu-item ${fn:contains(pageContext.request.requestURI, '/atdHistory') ? 'active' : '' }"
      >
      ...
      <li
        class="menu-item ${fn:contains(pageContext.request.requestURI, '/vacHistory') ? 'active' : '' }"
      >
