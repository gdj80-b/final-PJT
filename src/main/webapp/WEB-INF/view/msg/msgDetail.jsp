...
<body>
    ...
    <div id="workspace-area" class="subsidebar-from-workspace">
        <div class="card inbox-container">
            <div class="card-header d-flex align-items-start justify-content-between" style="padding-top: 0.5rem">
                <h2 class="title pt-2">${m.msgTitle}</h2>
            ...
            <div class="care-body">
                <div class="info" style="display: flex; font-weight: bold">
                    ...
                    <c:if test="${m.msgFileName!=null}">
                        <a class="msg-file-text" href="${pageContext.request.contextPath}/upload/msgfile/${m.msgFileName}" target="_blank"> ${m.msgOriginalFileName} </a>
                    </c:if>
                </div>
