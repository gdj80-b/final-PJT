          ...
          <div class="flex-grow-1 home-container">
            <div class="row row-cols-3 mb-5">
              <div class="col-md-2 mb-3 d-flex justify-content-center">
                <jsp:include
                  page="/WEB-INF/view/home/profile-card.jsp"
                ></jsp:include>
              </div>
              <div class="col-md-4 mb-3 d-flex justify-content-center">
                <jsp:include
                  page="/WEB-INF/view/home/calendar-card.jsp"
                ></jsp:include>
              </div>
              <div class="col-md-4 mb-3 d-flex justify-content-center">
                <jsp:include
                  page="/WEB-INF/view/home/alert-card.jsp"
                ></jsp:include>
              </div>
            </div>
            <div class="row row-cols-3 mb-5">
              <div class="col-md-2 mb-3 d-flex justify-content-center">
                <jsp:include
                  page="/WEB-INF/view/home/attendance-card.jsp"
                ></jsp:include>
              </div>
              <div class="col-md-4 mb-3 d-flex justify-content-center">
                <jsp:include
                  page="/WEB-INF/view/home/notice-card.jsp"
                ></jsp:include>
              </div>
              <div class="col-md-4 mb-3 d-flex justify-content-center">
                <jsp:include
                  page="/WEB-INF/view/home/navernews-card.jsp"
                ></jsp:include>
              </div>
            </div>
          </div>
