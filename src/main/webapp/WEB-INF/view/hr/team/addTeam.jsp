	...
	<div id="">
	    ...
	    <!-- 작업 공간 시작 -->
		    ...
		    <div class="table-responsive text-nowrap">
		    	<form action="/gaent/hr/addTeam" method="post">
		        	...
		        	<tbody>
		                	...
		                	<button type="button" class="btn btn-primary" onclick="checkTeamCode()">중복검사</button>
		              		...
		              		<td class="type-draft-td-tag">
			                	<div class="edoc-type-select-box">
			                  		<select id="parentTeamCode" class="form-select form-select-sm" name="parentTeamCode">
		            	...
		            	<tr>
		              		...
		              		<td class="type-draft-td-tag" colspan="3">
		                		<textarea class="form-control" rows="12" name="teamDes" id="teamDes"></textarea>
		              		</td>
		            	</tr>
		        	</tbody>
		        	</table>
