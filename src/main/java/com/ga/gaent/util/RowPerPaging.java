...
public class RowPerPaging {
    
    public Map<String,Object>Paging(int currentPage, int paramRowPerPage, int totalRow){
        
        // int currentPage = 1;    // 현재 페이지 번호
        int rowPerPage = 10;    // 페이지 당 기본 레코드 수
        if(paramRowPerPage != 0) {
